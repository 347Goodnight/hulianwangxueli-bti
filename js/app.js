...
const personalityTaxonomy = {
  ...
  SHUANGF: { category: '学历落差系', keywords: ['双非', '学校', '自证', '简历'] },
  JINGSH: { category: '学历落差系', keywords: ['精神本科生', '包装', '气势', '牌面'] },
  FUDUS: { category: '升学补票系', keywords: ['复读', '重开', '高考', '不服'] },
  KAOYAN2: { category: '升学补票系', keywords: ['考研', '二战', '调剂', '上岸'] },
  BAOFOJ: { category: '升学补票系', keywords: ['抱佛脚', '突击', '补票', '考前'] },
  ZHUANBS: { category: '升学补票系', keywords: ['专升本', '逆袭', '本科', '补票'] },
  HANSHOU: { category: '升学补票系', keywords: ['函授', '成人学历', '补证', '门票'] },
  CHAONL: { category: '学历资源系', keywords: ['资源', '钞能力', '家境', '门路'] },
  LIUSHUI: { category: '学历资源系', keywords: ['留学', '水硕', '海归', '包装'] },
  MINBAN: { category: '学历资源系', keywords: ['民办', '学费', '贵族', '性质'] },
  YEJIZH: { category: '学历风险系', keywords: ['野鸡院校', '校名', '包装', '翻车'] },
  DAZHUAN: { category: '学历风险系', keywords: ['大专', '反打', '学历', '战狼'] },
  WENMANG: { category: '学历风险系', keywords: ['文盲', '认知', '规则', '掉线'] },
  CHANGG: { category: '就业现实系', keywords: ['厂狗', '就业', '包住', '现实'] },
  ZHONGZWH: { category: '下沉学历系', keywords: ['中专', '文豪', '评论区', '感悟'] },
  BAILAN: { category: '下沉学历系', keywords: ['摆烂', '躺着', '学历', '算了'] }
};
const libraryCategoryMeta = {
  全部: { icon: '总', label: '完整图鉴' },
  名校光环系: { icon: '名', label: '光环牌桌' },
  学历落差系: { icon: '差', label: '落差现场' },
  升学补票系: { icon: '升', label: '补票上岸' },
  学历资源系: { icon: '资', label: '资源路线' },
  学历出身系: { icon: '历', label: '出身标签' },
  学历风险系: { icon: '险', label: '翻车地带' },
  下沉学历系: { icon: '下', label: '下沉样本' },
