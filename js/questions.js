...
const questions = [
  ...
  // 以下题目为新增高攻击性题目
  {
    id: 'q31',
    dim: 'B1',
    text: '你觉得自己是废物吗？（认真想三秒再答）',
    options: [
      { text: '曾经是，但现在在改', value: 3 },
      { text: '偶尔是，看和谁比', value: 2 },
      { text: '别骂了，我就是', value: 1 }
    ]
  },
  {
    id: 'q32',
    dim: 'B2',
    text: '看到同龄人已经年薪百万，你还在刷这个测试，什么感觉？',
    options: [
      { text: '焦虑完了继续干，我还能抢救', value: 3 },
      { text: '酸一下，然后继续刷', value: 2 },
      { text: '他们已经赢了，我躺平', value: 1 }
    ]
  },
  {
    id: 'q33',
    dim: 'E2',
    text: '如果学历可以重来，你觉得以你当年的努力程度，能改变什么吗？',
    options: [
      { text: '至少比现在好，因为知道了方向', value: 3 },
      { text: '可能会好一点，但有限', value: 2 },
      { text: '重开多少次都差不多，我就是这水平', value: 1 }
    ]
  },
  {
    id: 'q34',
    dim: 'A1',
    text: '你每天刷这么多焦虑视频，是因为闲还是因为真的无能为力？',
    options: [
      { text: '闲的时候刷，但刷完真会行动', value: 3 },
      { text: '两者都有，控制不住', value: 2 },
      { text: '别说了，就是在逃避现实', value: 1 }
    ]
  },
  {
    id: 'q35',
    dim: 'S2',
    text: '你父母知道你在网上做这种"学历测试"吗？知道会说什么？',
    options: [
      { text: '知道，他们无所谓/支持', value: 3 },
      { text: '不知道，也没必要让他们知道', value: 2 },
      { text: '不敢让他们知道，怕被失望', value: 1 }
    ]
  },
