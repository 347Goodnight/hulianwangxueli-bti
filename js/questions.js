...
const questions = [
  {
    ...
    options: [
      ...
      { text: '当天就能接上，顺手还能改一版', score: 2, types: { KOUHAI: 1, GANG: 1, VALO: 1, GENSHIN: 1 } }
    ]
  },
  {
    id: 'q2',
    ...
    options: [
      ...
      { text: '不用解释，我甚至还能顺着说', score: 2, types: { GANG: 2, VALO: 1, GENSHIN: 1 } }
    ]
  },
  {
    id: 'q3',
    ...
    options: [
      ...
      { text: '不用展开，我已经猜到他是哪路话术了', score: 2, types: { XYY: 2, GANG: 1, JIAHAO: 1 } }
    ]
  },
  {
    id: 'q4',
    ...
    options: [
      ...
      { text: '越被玩烂，我越想拿来整活', score: 2, types: { KOUHAI: 2, VALO: 1 } }
    ]
  },
  {
    id: 'q5',
    ...
    options: [
      ...
      { text: '不回两句我真的难受', score: 2, types: { GANG: 2, ANDROID: 1, VALO: 1 } }
    ]
  },
  {
    id: 'q6',
    ...
    options: [
      ...
      { text: '参数和生态，我能跟他掰到底', score: 2, types: { ANDROID: 3, GANG: 1 } }
    ]
  },
  {
    id: 'q7',
    ...
    options: [
      ...
      { text: '这口气我必须给他还回去', score: 2, types: { GANG: 2, KOUHAI: 1, VALO: 1 } }
    ]
  },
  {
    id: 'q8',
    ...
    options: [
      ...
      { text: '这我熟，我能帮他吹得更大', score: 2, types: { KOUHAI: 3, JIAHAO: 1 } }
    ]
  },
  {
    id: 'q9',
  ...
  },
  {
    ...
    options: [
      ...
      { text: '角色、设定、赛区、圈内黑话', score: 2, types: { GENSHIN: 2, VALO: 2 } }
    ]
  },
  {
    id: 'q17',
  ...
  },
  {
    ...
    options: [
      ...
      { text: '我会来一句，把场子重新点起来', score: 2, types: { JIAHAO: 2, KOUHAI: 1, VALO: 1 } }
    ]
  },
  {
    id: 'q19',
    ...
    options: [
      ...
      { text: '我已经开始脑补配音和旁白了', score: 2, types: { JIAHAO: 2, KOUHAI: 1 } }
    ]
  },
  {
    id: 'q20',
    ...
    options: [
      ...
      { text: '我自己先脑补出一整部连续剧', score: 2, types: { CLOWN: 3, DOOM: 1, PURE: 1 } }
    ]
  },
  {
    id: 'q21',
  ...
  },
  {
    ...
    options: [
      ...
      { text: '越翻越上头，还想把细节全补齐', score: 2, types: { CLOWN: 3, DOOM: 1 } }
    ]
  },
  {
    id: 'q23',
    ...
    options: [
      ...
      { text: '当下装没事，回去越想越多', score: 2, types: { DOOM: 2, CLOWN: 1 } }
    ]
  },
  {
    id: 'q24',
  ...
  },
  {
    ...
    options: [
      ...
      { text: '别说，这套有时候还真解释得通', score: 2, types: { XYY: 3 } }
    ]
  }
];
